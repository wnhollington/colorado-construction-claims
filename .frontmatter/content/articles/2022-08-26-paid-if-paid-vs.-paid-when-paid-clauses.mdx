---
title: Paid if Paid vs. Paid when Paid Clauses
slug: paid-paid-paid-paid-clauses
description: Although many states do not recognize pay-if-paid clauses, Colorado does.  However, contractors must be careful, as specific language is required to ensure they are enforceable.
